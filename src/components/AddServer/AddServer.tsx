import { Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Fab, Grid, IconButton, makeStyles, TextField, Tooltip, Typography } from '@material-ui/core';
...
const AddServer = () => {
  ...
  return (
    <>
      <Tooltip title="Add">
        <Fab color="primary" component={IconButton} className={classes.absolute} onClick={handleClickOpen}>
          <AddIcon />
        </Fab>
      </Tooltip>
      <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        <form onSubmit={(e) => addServer(e)}>
          <DialogTitle id="form-dialog-title">Server hinzufügen</DialogTitle>
          <DialogContent>
            <DialogContentText>
